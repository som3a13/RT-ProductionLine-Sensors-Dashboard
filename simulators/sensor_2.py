"""
Sensor 2 Simulator - Pressure Sensor
...
class Sensor2Simulator:
    """PTY-based simulator for Sensor 2 (Pressure Sensor)"""
    ...
    def __init__(self, baudrate=115200, bytesize=8, parity='N', stopbits=1):
        ...
        self.sensor_id = 2
        self.sensor_name = "Pressure Sensor 1"
        self.low_limit = 50.0
        self.high_limit = 150.0
        self.unit = "PSI"
    ...
    def create_working_frame(self, value: float) -> bytes:
        """
        Create working frame for Sensor 2
...
def main():
    ...
    parser = argparse.ArgumentParser(description='Sensor 2 (Pressure) PTY Simulator')
